...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        ...
        let r = u8::try_from(red).map_err(|_| IntoColorError::IntConversion)?;
        let g = u8::try_from(green).map_err(|_| IntoColorError::IntConversion)?;
        let b = u8::try_from(blue).map_err(|_| IntoColorError::IntConversion)?;
